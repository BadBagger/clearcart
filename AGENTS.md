# ClearCart Agent Instructions

Future Codex chats working in this repository should also read the shared
SoftSmith DevHub context:
...
If ClearCart becomes an Android app, do not call it published until a GitHub
